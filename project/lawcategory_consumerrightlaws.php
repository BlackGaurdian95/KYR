...
<head>
  ...
  <title>Consumer Right Laws | Know Your Rights</title>
...
<!-- <div class="container">
  ...
  <div class="situation-tabs">
    ...
    <a href="lawcategory_consumerrightlaws.php" class="situation-tab active">Consumer Right Laws</a>
    <a href="lawcategory_personalinjurylaws.php" class="situation-tab">Personal Injury Laws</a>
  </div>

  <div class="section">
    <h2>Consumer Right Laws</h2>
    <p>Consumer Right Law covers some of the most personal and life-changing issues you may encounter. From starting a marriage to navigating custody, support, and safety concerns, understanding your rights is crucial for protecting yourself and your loved ones.</p>
    <br>
    <!-- Law Card Example -->
    <div class="law-card">
