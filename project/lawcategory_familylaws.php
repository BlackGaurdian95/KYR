...
<head>
  ...
  <title>Family Laws| Know Your Rights</title>
...
<!-- <div class="container">
  ...
  <div class="situation-tabs">
    <a href="lawcategory_familylaws.php" class="situation-tab active">Family Laws</a>
  ...
  <div class="section">
    <h2>Family Laws</h2>
    <p>Family Law covers some of the most personal and life-changing issues you may encounter. From starting a marriage to navigating custody, support, and safety concerns, understanding your rights is crucial for protecting yourself and your loved ones.</p>
    <br>
    <!-- Law Card Example -->
    <div class="law-card">
