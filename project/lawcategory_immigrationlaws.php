...
<head>
  ...
  <title>Immigration Laws | Know Your Rights</title>
...
<!-- <div class="container">
  ...
  <div class="situation-tabs">
    ...
    <a href="lawcategory_immigrationlaws.php" class="situation-tab active">Immigration Laws</a>
  ...
  <div class="section">
    ...
    <p>Immigration Law covers some of the most personal and life-changing issues you may encounter. From starting a marriage to navigating custody, support, and safety concerns, understanding your rights is crucial for protecting yourself and your loved ones.</p>
    <br>
    <!-- Law Card Example -->
    <div class="law-card">
