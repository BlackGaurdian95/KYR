...
<head>
  ...
  <title>Personal Injury Laws | Know Your Rights</title>
...
<!-- <div class="container">
  <div class="search-container">
    <input type="text" class="search-input" placeholder="Search for a specific traffic law or situation...">
  </div> -->
  ...
  <div class="situation-tabs">
    ...
    <a href="lawcategory_personalinjurylaws.php" class="situation-tab active">Personal Injury Laws</a>
  </div>

  <div class="section">
    <h2>Personal Injury Laws</h2>
    <p>Personal Injury Law covers some of the most personal and life-changing issues you may encounter. From starting a marriage to navigating custody, support, and safety concerns, understanding your rights is crucial for protecting yourself and your loved ones.</p>
    <br>
    <!-- Law Card Example -->
    <div class="law-card">
